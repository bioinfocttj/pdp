...
public class My_macro2 implements PlugIn {
   public int w=2048; //image width
   public int h=2048; //image heigh
   public int radiusMin=30; //radius min of the draw circule
   public int radiusMax=60; //radius max of the draw circule
   public int radiusInc=5; //radius incrementation
   static String name = "";
...
//creation of an image which contains a circule with different diameters
