...
Lorsque l'utilisateur fait le choix d'un algorithme de piquage parmi ceux qui lui sont proposés, cela fait appel à la classe \texttt{AlgoFactory} contenant une méthode switch. Celle-ci permet de récupérer le nom de l'algorithme choisi et d'afficher le panel2 correspondant. \\
