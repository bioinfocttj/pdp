...
Les méthodes de piquage implémentent une \textcolor{blue}{interface} car elles ne nécessitent pas l'utilisation une classe mère. L'utilisateur sélectionne un algorithme dans le menu déroulant et détermine certains paramètres. Quelques uns sont propres aux algorithmes et d'autres sont communs à tous tel que :
